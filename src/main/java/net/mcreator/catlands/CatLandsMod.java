...
@Mod("cat_lands")
public class CatLandsMod {
	public static final Logger LOGGER = LogManager.getLogger(CatLandsMod.class);
	public static final String MODID = "cat_lands";

	public CatLandsMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();

		CatLandsModBlocks.REGISTRY.register(bus);

		CatLandsModItems.REGISTRY.register(bus);

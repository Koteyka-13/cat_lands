...
public class KotegolemEntity extends Monster {
	public KotegolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CatLandsModEntities.KOTEGOLEM.get(), world);
	}

	public KotegolemEntity(EntityType<KotegolemEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(CatLandsModEntities.KOTEGOLEM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
